...
namespace savepoint_api_dotnet.Models
{
    ...
    public class Platform
    {
        ...
        public string Console { get; set; }    // ex. Switch, Switch 2, PS5, Xbox Series X, PC, etc.
        public string Stores { get; set; }  // Epic, Steam, GOG, etc. (if applicable)
        ...
        public string Variation { get; set; }   // ex. Switch OLED, Switch Lite, PS5 Digital Edition, etc.
